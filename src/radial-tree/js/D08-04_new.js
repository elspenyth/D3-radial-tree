function show() {
    ...
    //My abstracted variables that are data dependent
    var filename = './data/cats.csv';
    var colour_set = 8;
    var colour_start_depth = 2;
    ...
    //var input_vars = require("inputs.json");
    //input_vars.filename = './data/OGS_business.csv';
    ...
    var colorScale = d3.scaleSequential(d3.interpolateSpectral).domain([0,colour_set]);
    ...
    // load the data
    d3.csv(filename, function(loaded) {
        ...
        var colorGroups = root.descendants().filter(function(node) {return node.depth === colour_start_depth});
